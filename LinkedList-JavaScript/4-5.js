...
class Linked_list {
     ...
     * 
     * @param  key o'chiriladigan elementni kiriting
     */
    deleteNode(key){
        // Listni boshini topib olamiz
        let temp = this.head;
        ...
        while (temp){
            ...
            // bizga bir o'zgaruvchi kerak, u o'zgaruvchini tashqarida ham foydalana olishimiz kerak
            // shuning uchun " var " dan foydalanamiz
            var prev = temp;
            temp = temp.next;
        }
